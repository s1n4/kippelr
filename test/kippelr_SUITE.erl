...
c_crud(_) ->
    ...
    {ok, {200, Result2}} = kippelr:modify_clip(Id, Clip1),
    Id1 = proplists:get_value(<<"id">>, Result1),
    Id = Id1,
    {ok, {200, Result3}} = kippelr:get_clip(Id1),
    Result2 = Result3,
    {ok, {201, Result4}} = kippelr:create_comment(Id, Comment),
    Id2 = proplists:get_value(<<"id">>, Result4),
